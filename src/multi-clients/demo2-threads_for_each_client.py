...
clients=[
{"broker":"test.mosquitto.org","port":1883,"name":"blank","sub_topic":"test1","pub_topic":"test1"},
{"broker":"broker.hivemq.com","port":1883,"name":"blank","sub_topic":"test2","pub_topic":"test2"}
]
